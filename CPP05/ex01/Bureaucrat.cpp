...
/*   Updated: 2025/05/21 16:42:35 by tgoudman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Bureaucrat::Bureaucrat(std::string name, unsigned int grade) :  _name(BLUE + name + RESET), _grade(grade)
{
	try{setGrade(grade);}
...
void		Bureaucrat::signForm(Form &form)
{
	...
	{
		if (_grade <= (size_t)form.getGrade())
			form.beSigned(*this);
		else
		{
